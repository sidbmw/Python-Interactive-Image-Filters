...
def two_tone(image: Image, colour_1: str, colour_2: str) -> Image:
    ...
    L = [("black", create_color(0, 0, 0)), ("white", create_color(255, 255, 255)), ("red", create_color(255, 0, 0)),
         ("lime", create_color(0, 255, 0)),
         ("blue", create_color(0, 0, 255)), ("yellow", create_color(255, 255, 0)), ("cyan", create_color(0, 255, 255)),
         ("magenta", create_color(255, 0, 255)), ("gray", create_color(128, 128, 128))]
    ...
    return show(image), save(new_image)


two_tone(original_image, "white", "black")
